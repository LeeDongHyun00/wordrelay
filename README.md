...
방장이 대기방에서 1~10라운드(기본 3)를 설정합니다. 설정 변경 시 준비가 해제됩니다. 각 라운드는 3초 카운트다운 뒤 6초로 시작하며, 정답마다 0.1초 감소해 최소 1초가 됩니다. 단어 사용 기록과 참가 상태는 매 라운드 초기화합니다. 표시는 2초 아래에서 ½속도, 1초 아래에서 ¼속도로 줄어들고 실제 서버 제한 시간도 연장됩니다.
