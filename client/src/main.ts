...
function paintTimer(){
 ...
 const label=document.querySelector('#timer-label');if(label)label.textContent=countdown>0?'곧 시작해요':stage==='critical'?'마지막 순간 · ¼속도':stage==='slow'?'천천히 · ½속도':'남은 시간';
